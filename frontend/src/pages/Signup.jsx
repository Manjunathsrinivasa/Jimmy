...
const FEATURES = [
  {
    ...
    desc: "Create your workspace, design a pipeline, and start running projects today.",
    icon: (
  ...
  },
  {
    ...
    desc: "Admins, managers, contributors, approvers and viewers — every page grantable.",
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
  ...
  },
  {
    ...
    desc: "Self-hosted and simple — no surprises, no vendor lock-in.",
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        <path
          fillRule="evenodd"
...
function PasswordField({ id, label, value, onChange, hint, autoComplete }) {
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-indigo-700 via-indigo-600 to-violet-600 p-12 text-white lg:flex">
        ...
        <div className="relative max-w-md">
          <h2 className="text-4xl font-bold leading-tight tracking-tight">
            Your workspace, ready in one step.
          </h2>
          <p className="mt-4 text-indigo-100/90">
            Signing up creates your organization and makes you its admin — then invite your team,
            design your first pipeline, and start delivering.
          </p>
      ...
      <div className="flex w-full items-center justify-center bg-slate-50 px-6 py-12 lg:w-1/2">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-1.5 text-sm text-gray-500">
            Signing up creates your organization — you'll be its admin.
          </p>
